import os
from flask_httpauth import HTTPBasicAuth #nuevo
from werkzeug.security import generate_password_hash, check_password_hash #nuevo
from itsdangerous import TimedJSONWebSignatureSerializer as Serializer #nuevo
from flask import Blueprint, current_app #nuevo
...
db = SQLAlchemy(app)
auth = HTTPBasicAuth() #nuevo
auth_token = HTTPBasicAuth() #nuevo
...
class User(db.Model):
    ...
    def generate_auth_token(self, expires_in=3600): #nuevo
...
app.register_blueprint(api) #nuevo
